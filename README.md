...
| **botdamagescale** | Scales the damage **bots deal to human players** (default half) — softens the "bot rounds a corner and instantly melts you" moment. Bot-vs-bot and your own shots are untouched. | `sm_botdamage_scale` (0.5 — `1.0` = off) |
